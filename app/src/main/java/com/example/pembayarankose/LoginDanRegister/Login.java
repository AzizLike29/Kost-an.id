package com.example.pembayarankose.LoginDanRegister;
...
import com.example.pembayarankose.Admin.Admin;
import com.example.pembayarankose.MainActivity;
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if (snapshot.child(username).exists()){
                                if (snapshot.child(username).child("password").getValue(String.class).equals(password)){
                                    ...
                                    Intent masuk = new Intent(getApplicationContext(), com.example.pembayarankose.Admin.Admin.class);
                                    startActivity(masuk);
                                }
                            }else{
